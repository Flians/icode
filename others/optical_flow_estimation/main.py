...
if __name__ == '__main__':
    ...
    parser.add_argument('--crop_size', type=int, nargs='+', default=[192, 256], help="Spatial dimension to crop training samples for training")
    ...
    tools.add_arguments_for_module(parser, models, argument_for_class='model', default='FlowNetERM')

    tools.add_arguments_for_module(parser, losses, argument_for_class='loss', default='MultiscaleLoss')

    tools.add_arguments_for_module(parser, torch.optim, argument_for_class='optimizer', default='Adam',
                                   skip_params=['params'],
                                   parameter_defaults={'optimizer_lr': 1e-4})
